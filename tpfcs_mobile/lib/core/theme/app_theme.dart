...
class AppBrand {
  static const navy     = Color(0xFF0D1B6E);
  static const navyLight= Color(0xFF1A2490);
  static const gold     = Color(0xFFFFBF00);
  static const goldDark = Color(0xFFCC9900);   // darker gold for light mode text
...
class AppColors {
  ...
  // Accent
  Color get gold       => AppBrand.gold;
  Color get goldActive => isDark ? AppBrand.gold : AppBrand.goldDark;
  Color get goldDim    => AppBrand.goldDim;
  Color get accentText => const Color(0xFF060A18); // always dark on gold bg
...
// ── Status color extensions (use theme-aware colors) ──────────────────────────
extension WorkflowStatusColor on String {
  ...
  Color statusBg(bool isDark) {
    final c = AppColors(isDark);
    switch (toLowerCase()) {
      case 'manifested':  return c.surface1;
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(14),
          borderSide: BorderSide(color: AppBrand.gold, width: 1.5),
        ),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          foregroundColor: const Color(0xFF060A18),
          elevation: 0,
